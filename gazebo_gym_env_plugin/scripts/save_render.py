...
rospy.init_node('save_render', anonymous=True, log_level=rospy.WARN)

name = "/gazebo/gym_env_interface/render"
rospy.wait_for_service(name)
srvProxy = rospy.ServiceProxy(name, gazebo_gym_env_plugin.srv.RenderCameras)
