...
#include <lr_gym_ros_utils/MoveToEePoseAction.h>
#include <lr_gym_ros_utils/MoveToJointPoseAction.h>
#include <lr_gym_ros_utils/GetJointState.h>
#include <lr_gym_ros_utils/GetEePose.h>
#include <lr_gym_ros_utils/AddCollisionBox.h>
#include <lr_gym_ros_utils/ClearCollisionObjects.h>


std::shared_ptr<actionlib::SimpleActionServer<lr_gym_ros_utils::MoveToEePoseAction>> moveToEePoseActionServer;
std::shared_ptr<actionlib::SimpleActionServer<lr_gym_ros_utils::MoveToJointPoseAction>> moveToJointPoseActionServer;
...
void moveToEePoseActionCallback(const lr_gym_ros_utils::MoveToEePoseGoalConstPtr &goal)
{
  try
  {
...
void moveToJointPoseActionCallback(const lr_gym_ros_utils::MoveToJointPoseGoalConstPtr &goal)
{
  try
  {
...
bool getJointStateServiceCallback(lr_gym_ros_utils::GetJointState::Request& req, lr_gym_ros_utils::GetJointState::Response& res)
{
...
bool getEePoseServiceCallback(lr_gym_ros_utils::GetEePose::Request& req, lr_gym_ros_utils::GetEePose::Response& res)
{
...
bool addCollisionBoxServiceCallback(lr_gym_ros_utils::AddCollisionBox::Request& req, lr_gym_ros_utils::AddCollisionBox::Response& res)
{
...
bool clearCollisionObjectsServiceCallback(lr_gym_ros_utils::ClearCollisionObjects::Request& req, lr_gym_ros_utils::ClearCollisionObjects::Response& res)
{
...
int main(int argc, char** argv)
{
  ...
  moveToEePoseActionServer = std::make_shared<actionlib::SimpleActionServer<lr_gym_ros_utils::MoveToEePoseAction>>(node_handle,
                                                                                                                  "move_to_ee_pose",
                                                                                                                  moveToEePoseActionCallback,
                                                                                                                  false);
  moveToEePoseActionServer->start();

  moveToJointPoseActionServer = std::make_shared<actionlib::SimpleActionServer<lr_gym_ros_utils::MoveToJointPoseAction>>(node_handle,
                                                                                                                        "move_to_joint_pose",
