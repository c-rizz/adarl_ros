 ...
 * topic of type \c lr_gym_ros_utils/LinkStates. The following is a basic configuration of the controller.
 *
 * \code
 * joint_state_controller:
 *   type: lr_gym_ros_utils/LinkStatePublisherController
 *   publish_rate: 50
 * \endcode
 *
...
private:
  ...
  std::shared_ptr<realtime_tools::RealtimePublisher<lr_gym_ros_utils::LinkStates> > realtime_pub_;
