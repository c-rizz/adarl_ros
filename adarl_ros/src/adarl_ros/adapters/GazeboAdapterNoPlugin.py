...
from adarl.utils.utils import Pose, buildRos1PoseStamped
from adarl_ros.utils.gazebo_models_manager import delete_model, spawn_model
import rospkg
import adarl.utils
        ...
        while not done and not rospy.is_shutdown():
            if counter < maxRetry:
                try:
                    ...
                    rospy.logerr("Service "+serviceProxy.resolved_name+", call failed: "+adarl.utils.utils.exc_to_str(e))
                except rospy.ROSInterruptException as e:
                    rospy.logerr("Service "+serviceProxy.resolved_name+", call interrupted: "+adarl.utils.utils.exc_to_str(e))
                    counter+=maxRetry #don't retry
                except rospy.ROSSerializationException as e:
                    rospy.logerr("Service "+serviceProxy.resolved_name+", call failed to serialize: "+adarl.utils.utils.exc_to_str(e))
                counter += 1
            else:
