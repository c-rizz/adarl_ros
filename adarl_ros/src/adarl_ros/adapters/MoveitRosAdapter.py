...
"""This file implements the MoveitRosAdapter class."""
...
import adarl_ros_utils.msg
import adarl_ros_utils.srv
import numpy as np
import rospy
...
from adarl.utils.utils import MoveFailError
...
class MoveitRosAdapter(RosAdapter, BaseCartesianPositionAdapter, BaseJointPositionAdapter):
    ...
    def startup(self):
        ...
        self._addCollisionBoxService = self._connectRosService("/move_helper/add_collision_box", adarl_ros_utils.srv.AddCollisionBox)
        self._clearCollsionBoxesService = self._connectRosService("/move_helper/clear_collision_objects", adarl_ros_utils.srv.ClearCollisionObjects)

        self._moveEeClient = self._connectRosAction('/move_helper/move_to_ee_pose', adarl_ros_utils.msg.MoveToEePoseAction)
        self._moveJointClient = self._connectRosAction('/move_helper/move_to_joint_pose', adarl_ros_utils.msg.MoveToJointPoseAction)
    ...
    def _controlJointPosition(self, jointPositions : Dict[Tuple[str,str],float],
        ...
        goal = adarl_ros_utils.msg.MoveToJointPoseGoal()
    ...
    def _controlEEPose(self, eePose_xyz_xyzw : List[float],
        ...
        goal = adarl_ros_utils.msg.MoveToEePoseGoal()
        goal.pose = adarl.utils.utils.buildRos1PoseStamped(eePose_xyz_xyzw[0:3],eePose_xyz_xyzw[3:7],
    ...
    def resetWorld(self):
        ...
        for i in range(5):
            try:
                ...
                ggLog.error("Reset move failed. exception = "+adarl.utils.utils.exc_to_str(e))
    ...
    def addCollisionBox(self,   pose_xyz_xyzw : Tuple[float,float,float,float,float,float,float],
        ...
        req = adarl_ros_utils.srv.AddCollisionBoxRequest()
