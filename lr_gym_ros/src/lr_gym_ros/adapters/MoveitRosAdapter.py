...
class MoveitRosAdapter(RosAdapter, BaseCartesianPositionAdapter, BaseJointPositionAdapter):
    ...
    def startup(self):
        ...
        self._clearCollsionBoxesService = self._connectRosService("/move_helper/clear_collision_objects", lr_gym_ros_utils.srv.ClearCollisionObjects)

        self._moveEeClient = self._connectRosAction('/move_helper/move_to_ee_pose', lr_gym_ros_utils.msg.MoveToEePoseAction)
        self._moveJointClient = self._connectRosAction('/move_helper/move_to_joint_pose', lr_gym_ros_utils.msg.MoveToJointPoseAction)
