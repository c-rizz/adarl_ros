...
from lr_gym_ros.envs.BaseEnv import BaseEnv
import os
import traceback
import lr_gym_ros.utils.dbg.ggLog as ggLog
import cv2

from lr_gym_ros.envs.ControlledEnv import ControlledEnv
import multiprocessing as mp
import signal

class GymEnvWrapper(gym.GoalEnv):
    """This class is a wrapper to convert lr_gym_ros environments in OpenAI Gym environments.
    ...
    def __init__(self,
        ...
        self._envStepDurationAverage =lr_gym_ros.utils.utils.AverageKeeper(bufferSize = 100)
        self._ggEnv.submitActionDurationAverage =lr_gym_ros.utils.utils.AverageKeeper(bufferSize = 100)
        self._observationDurationAverage =lr_gym_ros.utils.utils.AverageKeeper(bufferSize = 100)
        self._wallStepDurationAverage =lr_gym_ros.utils.utils.AverageKeeper(bufferSize = 100)
