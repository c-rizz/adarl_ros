...
from lr_gym_ros.envControllers.EffortRosControlController import EffortRosControlController
import lr_gym_ros
...
class PandaEffortBaseEnv(ControlledEnv):
    ...
    def __init__(   self,
                    ...
                    environmentController : lr_gym_ros.envControllers.EnvironmentController = None,
        ...
        environmentController : lr_gym_ros.envControllers.EnvironmentController
    ...
    def buildSimulation(self, backend : str = "gazebo"):
        ...
        self._environmentController.build_scenario(launch_file_pkg_and_path=("lr_gym_ros","/launch/launch_panda.launch"),
