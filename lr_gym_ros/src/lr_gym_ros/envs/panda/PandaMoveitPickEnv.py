...
from lr_gym_ros.envControllers.MoveitGazeboController import MoveitGazeboController
...
from lr_gym_ros.utils.utils import JointState, LinkState
...
class PandaMoveitPickEnv(ControlledEnv):
    ...
    def buildSimulation(self, backend : str = "gazebo"):
        if backend == "gazebo":
            self._environmentController.build_scenario(launch_file_pkg_and_path=("lr_gym_ros","/launch/panda_moveit_pick.launch"),
