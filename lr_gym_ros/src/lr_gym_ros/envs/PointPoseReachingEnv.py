...
class PointPoseReachingEnv(BaseEnv):
    ...
    def __init__(   self,
                    goalPoseSamplFunc : Callable[[],lr_gym_ros.utils.utils.Pose],
                    ...
                    startPose : lr_gym_ros.utils.utils.Pose = lr_gym_ros.utils.utils.Pose(x=0,y=0,z=0,qx=0,qy=0,qz=0,qw=1)):
        """Short summary.
    ...
    def _getDist2goal(self, state : NDArray[(12,), np.float32]):
        ...
        orientation_dist2goal = lr_gym_ros.utils.utils.quaternionDistance(orientation_quat,goal_quat)
