...
def main(usePyBullet : bool = False,
        ...
        stepLength_sec : float = 0.02) -> None:
    ...
    model = TD3( MlpPolicy, env, action_noise=action_noise, verbose=1, batch_size=100,
                 ...
                 seed = RANDOM_SEED) #n_cpu_tf_sess is needed for reproducibility
...
if __name__ == "__main__":
    ...
    ap.add_argument("--savevideo", default=False, action='store_true', help="Save a video of the training")
    ap.add_argument("--iterations", default=150000, type=int, help="Number of training steps to perform")
    ap.add_argument("--steplength", default=0.02, type=float, help="Duration of a simulation step (seconds)")
