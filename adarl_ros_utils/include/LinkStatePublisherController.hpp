 ...
 * topic of type \c adarl_ros_utils/LinkStates. The following is a basic configuration of the controller.
 *
 * \code
 * joint_state_controller:
 *   type: adarl_ros_utils/LinkStatePublisherController
 *   publish_rate: 50
 * \endcode
 *
...
private:
  ...
  std::shared_ptr<realtime_tools::RealtimePublisher<adarl_ros_utils::LinkStates> > realtime_pub_;
