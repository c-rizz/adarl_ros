...
#include <adarl_ros_utils/LinkState.h>
#include <adarl_ros_utils/LinkStates.h>


namespace adarl_ros_utils
{
                                  ...
                                  ros::NodeHandle&                         controller_nh)
  {
    ...
    forwardKinematicsComputer = std::make_shared<adarl_ros_utils::ForwardKinematicsComputer>();

    // realtime publisher
    realtime_pub_.reset(new realtime_tools::RealtimePublisher<adarl_ros_utils::LinkStates>(root_nh, "link_states", 4));
    ...
    {
      realtime_pub_->msg_.link_states.push_back(adarl_ros_utils::LinkState());
    }
...
PLUGINLIB_EXPORT_CLASS( adarl_ros_utils::LinkStatePublisherController, controller_interface::ControllerBase)
