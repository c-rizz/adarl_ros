...
namespace adarl_ros_utils
{
  ...
  adarl_ros_utils::LinkStates ForwardKinematicsComputer::computeLinkStates(const sensor_msgs::JointState& msg)
  {
    ROS_DEBUG_STREAM("\n\n\n\n\n\n computeLinkStates");
    //ROS_INFO("got joints");
    ...
    adarl_ros_utils::LinkStates linkStates;
  ...
  geometry_msgs::PoseArray ForwardKinematicsComputer::getLinkPoses(const adarl_ros_utils::LinkStates& linkStates)
  {
    geometry_msgs::PoseArray poseArray;
    poseArray.header.frame_id = rootLinkName;
    poseArray.header.stamp = linkStates.header.stamp;
    for(adarl_ros_utils::LinkState ls : linkStates.link_states)
