...
#include <adarl_ros_utils/MoveToEePoseAction.h>
#include <adarl_ros_utils/MoveToJointPoseAction.h>
#include <adarl_ros_utils/GetJointState.h>
#include <adarl_ros_utils/GetEePose.h>
#include <adarl_ros_utils/AddCollisionBox.h>
#include <adarl_ros_utils/ClearCollisionObjects.h>


std::shared_ptr<actionlib::SimpleActionServer<adarl_ros_utils::MoveToEePoseAction>> moveToEePoseActionServer;
std::shared_ptr<actionlib::SimpleActionServer<adarl_ros_utils::MoveToJointPoseAction>> moveToJointPoseActionServer;
...
void moveToEePoseActionCallback(const adarl_ros_utils::MoveToEePoseGoalConstPtr &goal)
{
  try
  {
  ...
  catch(std::runtime_error& e)
  {
    ...
    adarl_ros_utils::MoveToEePoseResult result;
...
void moveToJointPoseActionCallback(const adarl_ros_utils::MoveToJointPoseGoalConstPtr &goal)
{
  try
  {
  ...
  catch(std::runtime_error& e)
  {
    ...
    ROS_WARN_STREAM(errorMsg);
    adarl_ros_utils::MoveToJointPoseResult result;
    result.succeded = false;
    result.error_message = errorMsg;
...
bool getJointStateServiceCallback(adarl_ros_utils::GetJointState::Request& req, adarl_ros_utils::GetJointState::Response& res)
{
...
bool getEePoseServiceCallback(adarl_ros_utils::GetEePose::Request& req, adarl_ros_utils::GetEePose::Response& res)
{
...
bool addCollisionBoxServiceCallback(adarl_ros_utils::AddCollisionBox::Request& req, adarl_ros_utils::AddCollisionBox::Response& res)
{
...
bool clearCollisionObjectsServiceCallback(adarl_ros_utils::ClearCollisionObjects::Request& req, adarl_ros_utils::ClearCollisionObjects::Response& res)
{
...
int main(int argc, char** argv)
{
  ...
  moveToEePoseActionServer = std::make_shared<actionlib::SimpleActionServer<adarl_ros_utils::MoveToEePoseAction>>(node_handle,
                                                                                                                  "move_to_ee_pose",
                                                                                                                  moveToEePoseActionCallback,
                                                                                                                  false);
  moveToEePoseActionServer->start();

  moveToJointPoseActionServer = std::make_shared<actionlib::SimpleActionServer<adarl_ros_utils::MoveToJointPoseAction>>(node_handle,
                                                                                                                        "move_to_joint_pose",
